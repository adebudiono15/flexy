...
<div class="pd-20 pt-0">
    ...
    <div class="card mt-4">
        <div class="row">
            <div class="col-md">
                <div class="card-body">
                    <h6 class="card-title mb-4">Tracking</h6>
                    <div class="container padding-bottom-3x mb-1">
                        <div class="card mb-3">
                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap justify-content-between py-3 px-2 bg-secondary">
                                ...
                                <div class="w-100 text-center py-1 px-2"><span class="text-medium">Expected Date:</span>
                                    SEP 09, 2017</div>
                            </div>
                            <div class="card-body">
                                <div
                        ...
                        <div
                            ...
                            <div class="text-left text-sm-right"><a class="btn btn-outline-primary btn-rounded btn-sm"
                                    href="orderDetails" data-toggle="modal" data-target="#orderDetails">View Order
                                    Details</a></div>
                        </div>
                    </div>
                </div>
